...
public interface ClubNoticeQueryService {
     ...
     * @return 공지사항 리스트
     */
    List<Notice> getNoticeList(Long clubId, boolean onlyImportant, Long cursorId, Integer size);
     ...
     * @return 투표 리스트
     */
    List<Vote> getVoteList(Long clubId, boolean onlyImportant, Long cursorId, Integer size);

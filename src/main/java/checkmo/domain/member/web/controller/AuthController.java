...
public class AuthController {
    ...
    @PostMapping("/signup")
    public ApiResponse<MemberResponseDTO.SignUpResponseDTO> signUp(@Valid @RequestBody MemberRequestDTO.SignUpRequestDTO request, HttpServletResponse response) {

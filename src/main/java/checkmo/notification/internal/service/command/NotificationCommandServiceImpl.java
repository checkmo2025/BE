...
public class NotificationCommandServiceImpl implements NotificationCommandService {
    ...
    public void createNotification(LikeEvent event) {
        ...
        Member proxySender = memberAPI.findMemberReferenceById(event.getSenderId());
    ...
    public void createNotification(FollowEvent event) {
        ...
        Member proxyFollower = memberAPI.findMemberReferenceById(event.getFollowerId()); // 팔로우 누른 사람
        Member proxyFollowing = memberAPI.findMemberReferenceById(event.getFollowingId()); // 팔로우 당하는 사람

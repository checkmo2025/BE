...
public interface BookStoryAPI {
     ...
     */
    BookStoryExternalDTO.BookStoryDetailResponse getBookStory(String memberId, Long bookStoryId);
     ...
     */
    BookStoryExternalDTO.BookStoryListResponse getBookStoriesByScope(String memberId,

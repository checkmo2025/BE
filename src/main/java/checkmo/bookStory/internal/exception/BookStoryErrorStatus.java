...
public enum BookStoryErrorStatus implements BaseErrorCode {
    ...
    BOOK_STORY_IMAGE_LIMIT_EXCEEDED(HttpStatus.BAD_REQUEST, "BOOK_STORY_IMAGE_400", "책 이야기 이미지는 최대 5개까지 업로드할 수 있습니다."),
    BOOK_STORY_IMAGE_INVALID(HttpStatus.BAD_REQUEST, "BOOK_STORY_IMAGE_401", "본인이 업로드한 책 이야기 이미지만 첨부할 수 있습니다."),
    ...
    COMMENT_IMAGE_LIMIT_EXCEEDED(HttpStatus.BAD_REQUEST, "COMMENT_IMAGE_400", "책 이야기 댓글 이미지는 최대 5개까지 업로드할 수 있습니다."),
    COMMENT_IMAGE_INVALID(HttpStatus.BAD_REQUEST, "COMMENT_IMAGE_401", "본인이 업로드한 책 이야기 댓글 이미지만 첨부할 수 있습니다."),

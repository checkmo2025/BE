 ...
 * 독서 클럽 조회 서비스
 * <p>
 * 독서 클럽 자체에 대한 조회 기능을 담당 ex) 독서 클럽 목록 조회, 검색 기능, 특정 독서 클럽 상세 정보 조회 등을 처리
 */
public interface ClubQueryService {
     ...
     * @throws ClubManagementException 클럽이 존재하지 않는 경우
     */
    Club validateClub(Long clubId) throws ClubManagementException;
}

...
public enum ClubManagementErrorStatus implements BaseErrorCode {
    ...
    CLUB_MEMBER_INVALID_STATUS(HttpStatus.BAD_REQUEST, "CLUB_403", "클럽 회원의 상태가 유효하지 않습니다."),
    ...
    CLUB_MEMBER_IS_NOT_ACTIVE(HttpStatus.CONFLICT, "CLUB_MEMBER_406", "활성 회원만(STAFF, MEMBER, OWNER)만 수행할 수 있습니다."),

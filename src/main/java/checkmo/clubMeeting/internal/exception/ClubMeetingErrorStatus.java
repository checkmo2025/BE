...
public enum ClubMeetingErrorStatus implements BaseErrorCode {
    ...
    TOPIC_FORBIDDEN(HttpStatus.FORBIDDEN, "TOPIC_403", "해당 발제에 대한 수정 또는 삭제 권한이 없습니다."),
    TOPIC_NOT_FOUND(HttpStatus.NOT_FOUND, "TOPIC_404", "발제를 찾을 수 없습니다."),

    // 한줄평
    BOOK_REVIEW_FORBIDDEN(HttpStatus.FORBIDDEN, "BOOK_REVIEW_403", "해당 한줄평에 대한 수정 또는 삭제 권한이 없습니다."),
    ...
    CLUB_MEMBER_INACTIVE(HttpStatus.FORBIDDEN, "CLUB_MEETING_404", "활동 중인 독서클럽 회원만 접근할 수 있습니다.");

...
public interface ClubMeetingCommandService {
     ...
     */
    Long updateMeeting(Meeting meeting, Club club, ClubMember clubMember,
     ...
     * @return 수정한 발제 ID
     */
    Long updateTopic(Long clubId, ClubMember clubMember, Long meetingId, Long topicId,
     ...
     */
    Boolean selectOrCancelTopic(ClubMember clubMember, Long meetingId, Long topicId,
     ...
     * @param request    한줄평 내용 DTO (내용 + 평점)
     */
    Long updateBookReview(ClubMember clubMember, Meeting meeting, Long reviewId,

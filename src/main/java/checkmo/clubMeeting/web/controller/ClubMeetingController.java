...
public class ClubMeetingController {
    ...
    public ApiResponse<MeetingResponseDTO.MeetingMemberListDTO> getMeetingMembers(
        ...
        MeetingResponseDTO.MeetingMemberListDTO members = clubAPI.findMeetingMembersByMeeting(meetingId, cursorId, size,
                memberId);
    ...
    public ApiResponse<MeetingResponseDTO.TeamMemberDTO> getTeamMembers(
        ...
        MeetingResponseDTO.TeamMemberDTO teamMembers = clubAPI.findTeamMembersByMeeting(meetingId, teamNumber,
                memberId);
